...
import ru.snptech.businessbanyabot.model.report.BusinessClients;
...
public class BusinessClientReportService implements ReportService {
    ...
    public File getReport(final ReportType type, final String input) {
        ...
        try {
            var businessClients = LabeledEnumUtil.fromId(BusinessClients.class, input);

            var users = userRepository.findAll(UserSpecification.hasBusinessClients(businessClients.getId()));
