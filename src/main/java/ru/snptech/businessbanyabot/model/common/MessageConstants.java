...
public class MessageConstants {
    ...
    public static final String GREETING_TEMPLATE =
        "Добрый день, %s, добро пожаловать в бот в нем проходит регистрация нового участника на вступление в сооощество \"Бизнес Баня Екатеринбург\". Для подачи заявки вам потребуется предоставить свой номер телефона и ваше ФИО, последовательно отвечая на вопросы бота.";
    ...
    public static final String VERIFICATION_NEED_MESSAGE = """
        ...
        ⚠️ Введите номер мобильного телефона, связанный с WhatsApp, подтверждая соглашение.
        """;

    // TODO добавить ссылку на WhatsApp
    public static final String SURVEY_COMPLETE_MESSAGE
        = "✅ Ваша заявка на вступление в сообщество принята. Контакты отправлены модератору. С Вами свяжутся через WhatsApp. Для оперативной связи можете написать на следующий аккаунт https://wa.me/79221998569";
