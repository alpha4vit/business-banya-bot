...
import static ru.snptech.businessbanyabot.types.ServiceConstantHolder.BITRIX_RQ_ADDRESS;
import static ru.snptech.businessbanyabot.types.ServiceConstantHolder.BITRIX_RQ_CITY;
import static ru.snptech.businessbanyabot.types.ServiceConstantHolder.BITRIX_RQ_COMMENT;
import static ru.snptech.businessbanyabot.types.ServiceConstantHolder.BITRIX_RQ_CONTACT_NAME;
import static ru.snptech.businessbanyabot.types.ServiceConstantHolder.BITRIX_RQ_CONTACT_PHONE;
import static ru.snptech.businessbanyabot.types.ServiceConstantHolder.BITRIX_RQ_CUSTOMER_NAME;
import static ru.snptech.businessbanyabot.types.ServiceConstantHolder.BITRIX_RQ_DEAL_ID;
import static ru.snptech.businessbanyabot.types.ServiceConstantHolder.BITRIX_RQ_DEAL_TYPE;
import static ru.snptech.businessbanyabot.types.ServiceConstantHolder.BITRIX_RQ_DECEASED_SURNAME;
import static ru.snptech.businessbanyabot.types.ServiceConstantHolder.BITRIX_RQ_REGION;
import static ru.snptech.businessbanyabot.types.ServiceConstantHolder.BITRIX_RQ_SOURCE;
import static ru.snptech.businessbanyabot.types.ServiceConstantHolder.BITRIX_RQ_SOURCE_2;
